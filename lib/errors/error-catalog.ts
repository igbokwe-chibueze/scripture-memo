...
export const ERROR_CATALOG = [
  ...
  {
    code: "GME-001",
    title: "Gameplay session is unavailable",
    feature: "Gameplay",
    userMessage: "This gameplay session is no longer available.",
    explanation: "The requested session was not found, does not belong to the authenticated learner, is a Vault replay, or is no longer active. The response deliberately does not distinguish ownership failures.",
    commonCauses: ["A stale session URL was opened.", "A learner attempted to access another account's session.", "The session already completed."],
    examples: ["A copied session URL is opened under a different account."],
    solutions: ["Return to Day Selection and start or resume the challenge.", "Refresh if the session was opened from a stale tab."],
  },
  {
    code: "GME-002",
    title: "Game mode order conflict",
    feature: "Gameplay",
    userMessage: "Complete the current game mode before continuing.",
    explanation: "Modes must complete in the fixed Drag & Drop, Puzzle, Swap, Cue, Fill order. The server rejected an attempt to start or submit a later mode.",
    commonCauses: ["A stale tab submitted a previous or future mode.", "A direct request attempted to skip required modes."],
    examples: ["Fill is submitted before Cue has completed."],
    solutions: ["Refresh the gameplay screen and continue the mode shown there."],
  },
  {
    code: "GME-003",
    title: "Game mode attempt is no longer active",
    feature: "Gameplay",
    userMessage: "This attempt has ended. Start a new attempt.",
    explanation: "The attempt was already completed, failed, expired, or does not match the authenticated learner and active session.",
    commonCauses: ["A submission was repeated.", "A previous attempt was submitted from another tab."],
    examples: ["The same successful attempt is submitted twice."],
    solutions: ["Refresh and start the current mode again if it is not already complete."],
  },
  {
    code: "GME-004",
    title: "Timed game mode attempt expired",
    feature: "Gameplay",
    userMessage: "Time expired for this attempt. Try the mode again.",
    explanation: "The server compared its current time with the persisted attempt start and Journey Stage limit. Client timers cannot pause or extend that deadline.",
    commonCauses: ["The timer reached zero.", "The browser was backgrounded or the page remained open beyond the deadline."],
    examples: ["A Master attempt is submitted more than two minutes after its server start."],
  ...
  },
  {
    ...
    feature: "Gameplay",
    userMessage: "The verse is not fully correct yet. Try again.",
    explanation: "The server normalized and compared the submitted verse reconstruction with the session's trusted translation. No completion was recorded.",
    commonCauses: ["One or more words are missing, misplaced, or misspelled."],
    examples: ["A reordered phrase submission omits a word."],
    solutions: ["Review the feedback and start a fresh attempt for the same mode."],
  },
  {
    code: "GME-006",
    title: "Gameplay operation could not be completed",
    feature: "Gameplay",
    userMessage: "Gameplay could not be updated.",
    explanation: "An unexpected persistence or transaction failure prevented the gameplay operation from committing. Partial mode or day progress is rolled back.",
    commonCauses: ["A temporary database connection issue.", "A transaction timeout."],
    examples: ["The database disconnects while the final mode and day completion are committing."],
    solutions: ["Refresh and retry once.", "If the error repeats, inspect sanitized server logs."],
  },
