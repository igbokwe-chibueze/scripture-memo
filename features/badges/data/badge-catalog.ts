...
export const BADGE_CATALOG: readonly BadgeDefinition[] = [
  ...
  badge({ name: "Beacon Challenger", slug: "beacon-challenger", description: "Reach the Global Leaderboard top 100.", icon: "🌟", category: BadgeCategory.EXPLORATION, rarity: BadgeRarity.EPIC, criteriaKey: "LEADERBOARD_TOP_100", targetValue: 1, isHidden: true }),
] as const;
