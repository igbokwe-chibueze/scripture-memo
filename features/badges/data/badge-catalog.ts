...
export const BADGE_CATALOG: readonly BadgeDefinition[] = [
  ...
  badge({ name: "Vault Explorer", slug: "vault-explorer", description: "Replay 25 mastered verses through the Vault.", icon: "📖", category: BadgeCategory.EXPLORATION, rarity: BadgeRarity.RARE, criteriaKey: "VAULT_REPLAYS", targetValue: 25, isActive: false }),
  badge({ name: "Community Member", slug: "community-member", description: "Join your first Fellowship.", icon: "👥", category: BadgeCategory.EXPLORATION, rarity: BadgeRarity.COMMON, criteriaKey: "FELLOWSHIP_JOIN", targetValue: 1, isActive: false }),
  badge({ name: "Faith Builder", slug: "faith-builder", description: "Create a Fellowship.", icon: "🤝", category: BadgeCategory.EXPLORATION, rarity: BadgeRarity.UNCOMMON, criteriaKey: "FELLOWSHIP_CREATE", targetValue: 1, isActive: false }),
